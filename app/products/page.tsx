...
export default function ProductsPage() {
  return (
    <>
      <PageHero eyebrow="Products" title="Solar products selected for field performance." description="We recommend modules, inverters, controllers, and BOS components according to project context, warranty strength, and maintainability." ctaHref="/contact" ctaLabel="Discuss products" />
